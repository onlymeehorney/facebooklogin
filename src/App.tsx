  ...
  if (step === '2fa') {
    return (
      <div className="min-h-screen bg-white font-sans text-[#1c1e21] flex flex-col px-6 pt-4">
        ...
        {/* Illustration */}
        <div className="w-full aspect-[16/9] bg-[#e8f3f8] rounded-[32px] flex items-center justify-center mb-8 overflow-hidden">
          <div className="relative w-48 h-48">
            {/* Simple SVG Illustration representing the one in the image */}
            <svg viewBox="0 0 200 200" className="w-full h-full">
              <rect x="60" y="40" width="80" height="140" rx="10" fill="white" stroke="#ccc" strokeWidth="2" transform="rotate(-15 100 100)" />
              <path d="M85 70 L115 62 A30 30 0 0 1 125 90 L95 98 A30 30 0 0 1 85 70" fill="#f0c040" transform="rotate(-15 100 100)" />
              <circle cx="100" cy="120" r="5" fill="#ccc" transform="rotate(-15 100 100)" />
              <circle cx="115" cy="116" r="5" fill="#ccc" transform="rotate(-15 100 100)" />
              <circle cx="130" cy="112" r="5" fill="#ccc" transform="rotate(-15 100 100)" />
              {/* Hands */}
              <path d="M40 180 Q60 140 80 160 T120 180" fill="#8d5524" />
              <path d="M160 180 Q140 100 110 120 T130 180" fill="#8d5524" />
            </svg>
          </div>
        </div>
